...
const Contact = () => {
  ...
  return (
    <div className='extrapage'>
        ...
        <div>
            <h1>We Are Always Open For Your Service</h1>
            <p>Good customer service means meeting your customers’ needs in a timely, efficient, and pleasant way.</p>
        </div>
        </div>
...
<p>Our Address</p>
<span>Near Bhutkhel Park,Tokha-3,Kathmandu</span>
            </div><br></br>
            <div className='why'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
